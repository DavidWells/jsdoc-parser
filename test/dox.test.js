...
module.exports = {
  ...
  'test .parseComments() complex': function(done){
    fixture('c.js', function(err, str){
      ...
      parseComments.description.html.should.equal('<p>Parse comments in the given string of <code>js</code>.</p>');
      parseComments.description.summaryHtml.should.equal('<p>Parse comments in the given string of <code>js</code>.</p>');
      parseComments.description.bodyHtml.should.equal('');
      ...
      parseTagTypes.description.html.should.equal('<p>Parse tag type string &quot;{Array|Object}&quot; etc.</p>');
  ...
  'test .parseComments() tags with tabs': function (done) {
    fixture('d-tabs.js', function (err, str) {
      ...
      first.description.html.should.equal('<p>Parse tag type string &quot;{Array|Object}&quot; etc.</p>');
      first.description.summaryHtml.should.equal('<p>Parse tag type string &quot;{Array|Object}&quot; etc.</p>');
      first.description.bodyHtml.should.equal('');
  ...
  'test .parseComments() classes': function (done){
    fixture('classes.js', function(err, str){
      ...
      comments[0].description.html.should.equal('<p>A Foo.</p>');
      ...
      comments[0].ctx.text.should.be.equal('new FooBar()');
      comments[0].line.should.equal(2);
      comments[0].codeStart.should.equal(7);

      // class constructor
      comments[1].description.html.should.equal('<p>construct a Foo</p>');
      ...
      comments[1].ctx.text.should.be.equal('FooBar.prototype.constructor()');
      comments[1].line.should.equal(9);
      comments[1].codeStart.should.equal(14);

      // class method
      comments[2].description.html.should.equal('<p>Method of the Foo class.</p>');
      comments[2].ctx.type.should.be.equal('method');
      comments[2].ctx.name.should.be.equal('bar');
      comments[2].ctx.constructor.should.be.equal('FooBar');
      comments[2].ctx.text.should.be.equal('FooBar.prototype.bar()');
      comments[2].line.should.equal(18);
      comments[2].codeStart.should.equal(22);

      // class static method
      comments[3].description.html.should.equal('<p>Static method of the Foo class.</p>');
      ...
      comments[3].ctx.text.should.be.equal('FooBar.staticMethod()');
      comments[3].line.should.equal(26);
      comments[3].codeStart.should.equal(30);

      // class static generator method
      comments[4].description.html.should.equal('<p>Static generator method of the Foo class.</p>');
      ...
      comments[4].ctx.text.should.be.equal('FooBar.*staticGeneratorMethod()');
      comments[4].line.should.equal(34);
      comments[4].codeStart.should.equal(38);

      // class generator method with computed name
      comments[5].description.html.should.equal('<p>Generator method with computed name.</p>');
      ...
      comments[5].ctx.text.should.be.equal('FooBar.prototype.*[Symbol.iterator]()');
      comments[5].line.should.equal(42);
      comments[5].codeStart.should.equal(46);

      // class setter
      comments[6].description.html.should.equal('<p>Setter for the blah property.</p>');
      ...
      comments[6].ctx.text.should.be.equal('FooBar.prototype.blah');
      comments[6].line.should.equal(50);
      comments[6].codeStart.should.equal(53);

      // class getter
      comments[7].description.html.should.equal('<p>Getter for the blah property.</p>');
      ...
      comments[8].ctx.text.should.be.equal('new Baz()');
      comments[8].line.should.equal(67);
      comments[8].codeStart.should.equal(70);

      // class constructor
      comments[9].description.html.should.equal('');
      ...
      comments[9].ctx.text.should.be.equal('Baz.prototype.constructor()');
      comments[9].line.should.equal(72);
      comments[9].codeStart.should.equal(75);

      // class
      comments[10].description.html.should.equal('');
      ...
      comments[11].ctx.text.should.be.equal('new Ipsum()');
  ...
  'test .parseComments() inline prototypes': function (done){
    fixture('prototypes-inline.js', function(err, str){
      ...
      // constructor
      comments[0].description.html.should.equal('<p>Luke, I am your constructor.</p>');
      comments[0].ctx.type.should.be.equal('constructor');
      comments[0].ctx.name.should.be.equal('Foo');
      comments[0].ctx.text.should.be.equal('Foo()');

      // prototype object
      comments[1].description.html.should.equal('<p>To be relevant or not to be. This is the question.</p>');
      comments[1].ctx.type.should.be.equal('prototype');
      comments[1].ctx.name.should.be.equal('Foo');
      comments[1].ctx.text.should.be.equal('Foo.prototype');

      // property as a named method function
      comments[2].description.html.should.equal('<p>Returns the first item.</p>');
      comments[2].ctx.type.should.be.equal('method');
      comments[2].ctx.name.should.be.equal('getFirst');
      comments[2].ctx.text.should.be.equal('Foo.prototype.getFirst()');

      // getter function
      comments[3].description.html.should.equal('<p>Returns the first item.<br />\nActs as an ES5 alias of <code>Foo.prototype.getFirst</code> for feature sake.</p>');
      comments[3].ctx.type.should.be.equal('property');
      comments[3].ctx.name.should.be.equal('first');
      comments[3].ctx.text.should.be.equal('Foo.prototype.first');

      // setter function
      comments[4].description.html.should.equal('<p>Sets an internal property.</p>');
      comments[4].ctx.type.should.be.equal('property');
      comments[4].ctx.name.should.be.equal('seed');
      comments[4].ctx.text.should.be.equal('Foo.prototype.seed');

      // property as an anonymous method function
      comments[5].description.html.should.equal('<p>Anonymous function on property.</p>');
      comments[5].ctx.type.should.be.equal('method');
      comments[5].ctx.name.should.be.equal('random');
      comments[5].ctx.text.should.be.equal('Foo.prototype.random()');

      // this should be a separated function
      comments[6].description.html.should.equal('<p>My only purpose is to check we do not inherit from any parent context.</p>');
  ...
  'test .parseComments() literal inline': function (done){
    fixture('literal-inline.js', function(err, str){
      ...
      // parent target
      comments[0].description.html.should.equal('<p>Targeted literal</p>');
      comments[0].ctx.type.should.be.equal('declaration');
      comments[0].ctx.name.should.be.equal('Target');
      comments[0].ctx.text.should.be.equal('Target');

      // literal property
      comments[1].description.html.should.equal('<p>Sub object</p>');
      comments[1].ctx.type.should.be.equal('property');
      comments[1].ctx.name.should.be.equal('options');
      comments[1].ctx.text.should.be.equal('options');

      // property as an anonymous method function
      comments[2].description.html.should.equal('<p>This function surely does something</p>');
      comments[2].ctx.type.should.be.equal('method');
      comments[2].ctx.name.should.be.equal('doSomething');
      comments[2].ctx.text.should.be.equal('doSomething()');

      // property as a named method function
      comments[3].description.html.should.equal('<p>And them something else</p>');
      comments[3].ctx.type.should.be.equal('method');
      comments[3].ctx.name.should.be.equal('doSomethingElse');
      comments[3].ctx.text.should.be.equal('doSomethingElse()');

     // getter function
      comments[4].description.html.should.equal('<p>This is the result of doing anything</p>');
      comments[4].ctx.type.should.be.equal('property');
      comments[4].ctx.name.should.be.equal('result');
      comments[4].ctx.text.should.be.equal('result');
  ...
  'test .parseComments() code with a multi-line comment on a single line': function(done){
    fixture('single-multiline.js', function(err, str){
      ...
      comments[0].description.html.should.equal('<p>Normal multiline doc block</p>');
      comments[1].description.html.should.equal('<p>Single-line multiline block</p>');
      comments[2].description.html.should.equal('<p>Unspaced-line multiline block</p>');
      comments[3].description.html.should.equal('<p>argument A</p>');
      comments[4].description.html.should.equal('<p>argument B</p>');
  ...
  'test .parseCodeContext() prototype property with value==null': function(){
    ...
    ctx.constructor.should.equal('Database');
    ctx.name.should.equal('$enabled');
    ctx.text.should.equal('Database.prototype.$enabled');
  ...
  'test .api() without inline code in comments': function(done) {
    fixture('a.js', function(err, str){
      ...
      const md = `  - [exports.version](#exportsversion)
...
`
  ...
  'test .parseComments() on single star comments with skipSingleStar=true': function (done) {
    fixture('single.js', function(err, str){
      ...
      // comments[0].description.html.should.be.empty;
      done();
    });
  },
  ...
  'test .parseComments() does not interpret jshint directives as jsdoc': function (done) {
    fixture('jshint.js', function (err, str){
      ...
      comments[0].description.html.should.equal("<p>something else</p>");
      done();
    });
  },
  ...
  'test skipPrefix': function (done) {
    fixture('skip_prefix.js', function (err, str){
      ...
      // console.log('skip_prefix.js', comments)
      comments.length.should.equal(1);
      comments[0].description.html.should.equal("<p>something else</p>");
      done();
    });
  ...
  'test event tags': function (done) {
    fixture('event.js', function (err, str){
      ...
      comments.length.should.equal(2);
      comments[0].description.html.should.equal("<p>Throw a snowball.</p>");
      comments[1].description.html.should.equal("<p>Snowball event.</p>");
  ...
  'test that quotes within strings are correctly handled': function (done) {
    fixture('string-quotes.js', function (err, str){
      ...
      comments[2].description.html.should.equal("<p>Three</p>");
      comments[3].description.html.should.equal("<p>Four</p>");
      comments[4].description.html.should.equal("<p>Five</p>");
      comments[5].description.html.should.equal("<p>Six</p>");
      comments[6].description.html.should.equal("<p>Seven</p>");
      comments[7].description.html.should.equal("<p>Eight</p>");
      done();
    });
  },
};
