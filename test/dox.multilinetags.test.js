...
module.exports = {
  'test .parseComments() multiline tags': function(done){
    fixture('multilinetags.js', function(err, str){
      ...
      onlyParam.tags[0].text.should.equal('{String} foo\none\ntwo\nthree');
      ...
      firstParam.tags[0].text.should.equal('{String} foo\none\ntwo\nthree');
      firstParam.tags[1].text.should.equal('last');
      firstParam.tags[1].html.should.equal('<p>last</p>');
      lastParam.tags.should.with.lengthOf(2);
      lastParam.tags[0].text.should.equal('first');
      ...
      lastParam.tags[1].text.should.equal('{String} foo\none\ntwo\nthree');
      midParam.tags.should.with.lengthOf(3);
      midParam.tags[0].type.should.equal('foo');
      midParam.tags[0].text.should.equal('first');
      ...
      midParam.tags[1].text.should.equal('{String} foo\none\ntwo\nthree');
      midParam.tags[2].text.should.equal('last');
      ...
      onlyReturn.tags[0].text.should.equal('{String}\none\ntwo\nthree');
      ...
      firstReturn.tags[0].text.should.equal('{String}\none\ntwo\nthree');
      firstReturn.tags[1].text.should.equal('last');
      firstReturn.tags[1].html.should.equal('<p>last</p>');
      lastReturn.tags.should.with.lengthOf(2);
      lastReturn.tags[0].text.should.equal('first');
      ...
      lastReturn.tags[1].text.should.equal('{String}\none\ntwo\nthree');
      midReturn.tags.should.with.lengthOf(3);
      midReturn.tags[0].text.should.equal('first');
      ...
      midReturn.tags[1].text.should.equal('{String}\none\ntwo\nthree');
      midReturn.tags[2].text.should.equal('last');
      midReturn.tags[2].html.should.equal('<p>last</p>');

      example.tags.should.with.lengthOf(1);
      example.tags[0].text.should.equal('test(one);\ntest(two);');
