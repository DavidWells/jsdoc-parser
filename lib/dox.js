...
exports.parseComment = function(str, options, allText, ref) {
  ...
  // parse comment body
  let tagText = tags[0]
  const startsWithExclaimation = tagText[0] === '!'
  // console.log('startsWithExclaimation', startsWithExclaimation)
  if (startsWithExclaimation) {
  ...
  comment.tags = []
  comment.isIgnored = startsWithExclaimation
