 ...
 */
function printTheTypeDef(obj, jsonObjects, name) {
  let output = ""
  // 0. A default name for our Definition
  const jsonDef = name || "json"
  const jsonTypes = []
  const leading = ' '
 ...
 */
function goThroughAndParse(jsonObjects, name) {
